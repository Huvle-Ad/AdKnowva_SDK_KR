...
연동시 애드노바(AdKnowva) 최신버전을 확인해 주세요. 현재 최신버전은 **1.5.3** 버전입니다. 
안드로이드 **minSDK 23 / targetSDK 33**
...
- [유니티 Plugin 다운로드](https://github.com/Huvle-Ad/AdKnowva_SDK_KR/releases/tag/1.5.3)
...
dependencies {
	...
	*/
	...
	implementation 'com.byappsoft.huvleadlib:HuvleAdLib:1.5.3' // Please implement after checking the latest version.
	.
	.
}
```
